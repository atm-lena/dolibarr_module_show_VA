...
/**
 * 	\file		core/triggers/interface_99_modMyodule_showtrigger.class.php
 * 	\ingroup	show
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modShow_Mytrigger.class.php
...
class InterfaceDeleteShows
{
	...
	function runTrigger($action, $object, $user, $langs, $conf) {
        ...
        if (empty($conf->show->enabled)) return 0;     // Module not active, we do nothing
        ...
        switch ($action) {
            case 'PRODUCT_DELETE':
                ...
                $show=new show($db);
                $lines = $show->fetchAll('ASC', '', 0, 0, array('customsql'=>'fk_product='.$object->id.''), 'AND');
